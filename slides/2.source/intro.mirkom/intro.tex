...
\begin{itemize}
 ...
 \pause \item Large-scale \emph{storage facilities} (PFS-Lustre, SweStore, Tape)
...
\emph{Management}
\begin{itemize}
 \item Paolo Bientinesi, \emph{new} director
...
\begin{itemize}
 ...
 \begin{itemize}
  ...
  \end{itemize}
  \pause \item {\color{cyan} Parallel file system} \emph{Deprecated!}
  \begin{itemize}
   \item \texttt{/pfs/nobackup/home/X/Xyz}, user owned
  \end{itemize}
...
\begin{itemize}
 ...
 \begin{itemize}
  ...
  \item Are there other reasons for using HPC resources?
 \end{itemize}
\end{itemize}
}
