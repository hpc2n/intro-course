...
\usepackage{color,multirow,hhline}
\usepackage{csquotes}
...
\titlegraphic{\center{\includegraphics[height=1.1cm]{figures/naiss.png}\hspace*{0.5cm}~
   \includegraphics[height=1.1cm]{figures/umu-logotyp-EN.png}\hspace*{0.5cm}~\includegraphics[height=1.1cm]{figures/hpc2n-logo-text5.png}
}}
%% \titlegraphic{
%%  \centering
...
\begin{textblock*}{100mm}(-8mm,81mm)
 \includegraphics[height=4mm]{figures/umu-logo-left-EN.png}
 \includegraphics[height=4mm]{figures/naiss.png}
...
\begin{itemize}
 ...
 \pause \item National Data Science Node in ”Epidemiology and Biology of Infections” (DDLS)
...
%%  \begin{center}
%%   \vspace{5mm}
%%   \includegraphics[height=13mm]{figures/umu-logotyp-EN.png}\hspace{10mm}
...
\end{scriptsize}
 ...
 \begin{itemize}
  ...
  \item Parallel programming and tools (OpenMP, MPI, debugging, perf. analyzers, Matlab, R, MD simulation, ML, GPU, \dots)
   ...
   \begin{itemize}
     \begin{scriptsize}
     \item \textbf{Using Python in an HPC environment}, week 20, 2024
  \item \textbf{Introduction to running R, Python, and Julia in HPC}, 12-14 March 2024
  \item \textbf{Basic Sungularity}, 13 February 2024
  \item \textbf{Introduction to Kebnekaise}, 18 January 2024
    \item \textbf{Updated list:} https://www.hpc2n.umu.se/events/courses
\end{scriptsize}
     \end{itemize}
 \end{itemize}
