...
\texttt{\#SBATCH -A SNIC2021-22-1017} \\
...
\frame{\frametitle{Important information}
  ...
  \begin{block}{}
    \begin{itemize}
    \item The course project has the following SNIC ID: SNIC2021-22-1017
    \item In order to use it in a batch job, add this to the batch script:
      \begin{itemize}
        \item \#SBATCH -A SNIC2021-22-1017
      \end{itemize}
    \item There are some nodes reserved for the course, in order to let
      us run small examples without having to wait for too long. Three nodes are regular Broadwell CPU nodes, two nodes are K80 GPU node. 
    \item These reservations are ONLY valid during the course:
      ...
      \end{itemize}
\item We have a storage project linked to the compute project. It is snic2021-22-1017. You find it in /proj/nobackup/snic2021-22-1017 
    \end{itemize}
  \end{block}
