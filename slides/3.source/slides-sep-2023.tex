...
\item You (your PI) will either choose a directory name when you/they apply for
      ...
      \item Since the storage project is shared between all users of
        ...
        \item For this course the storage is in \texttt{/proj/nobackup/hpc2n2023-102}
      \end{itemize}
    \end{block}
...
\frame{\frametitle{The Batch System}\framesubtitle{Accounting, Compute nodes, Kebnekaise}
  ...
  \begin{block}{}
\begin{center}
\includegraphics[width=9cm]{figures/Allocation-Kebnekaise-thin_v3.png}
\end{center}
  \end{block}
}
...
\texttt{\#SBATCH --output=job.\%J.out} 
 ...
 \texttt{\#SBATCH -p largemem} (largemem does not have general access) \\
